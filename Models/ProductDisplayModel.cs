...
namespace OnlineStore.Models
{
    public class ProductDisplayModel
    {
        ...
        public static List<ProductDisplayModel> SelectProducts()
        {
            ...
            string con_string = "Server=tcp:cloud-server.database.windows.net,1433;Initial Catalog = Cldv - DB1; Persist Security Info=False;User ID = JaydenServerAdminLogin; Password=JayMeeko01; MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout = 30;\r\n";
